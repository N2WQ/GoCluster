...
- For independent-agent, subagent, or delegation questions, route to the
  ...
  explicitly prohibited, that `scope-ledger-adversarial-review` and
  `go-code-quality-review` are read-only findings sources, and that the lead
  Codex agent owns approval gates, integration, validation claims,
