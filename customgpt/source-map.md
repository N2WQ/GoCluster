...
| Browser web terminal prototype | [cloudflare/web-terminal/README.md](https://raw.githubusercontent.com/N2WQ/GoCluster/main/cloudflare/web-terminal/README.md) | [docs/OPERATOR_GUIDE.md](https://raw.githubusercontent.com/N2WQ/GoCluster/main/docs/OPERATOR_GUIDE.md), [docs/decisions/ADR-0201-browser-web-terminal-prototype.md](https://raw.githubusercontent.com/N2WQ/GoCluster/main/docs/decisions/ADR-0201-browser-web-terminal-prototype.md), [telnet/README.md](https://raw.githubusercontent.com/N2WQ/GoCluster/main/telnet/README.md) |
...
- For subagent or delegation questions, route to the Subagent Use rules in
  ...
  emphasize that subagent findings are evidence and the lead Codex agent owns
  approval gates, integration, validation claims, traceability, and closeout.
