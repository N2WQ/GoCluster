...
try {
  ...
  foreach ($operationId in @("getVersion", "getSourceMap", "getTroubleshootingIndex", "getDoc", "getBundle", "listDir", "findFiles")) {
  ...
  Assert-ContainsLiteral $schemaPath "version: 4.6.0" "schema version is 4.6.0"
